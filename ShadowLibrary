...
Top.BackgroundColor3 = Color3.fromRGB(255, 255, 224)
...
TextLabel.Text = name
TextLabel.TextColor3 = Color3.fromRGB(112, 128, 144)
TextLabel.TextSize = 14.000

Toggle.Name = "Toggle"
Toggle.Parent = Top
Toggle.BackgroundColor3 = Color3.fromRGB(112, 128, 144)
Toggle.BackgroundTransparency = 1.000
Toggle.Position = UDim2.new(0.00900000613, 0, 0.142857149, 0)
Toggle.Rotation = 90.000
Toggle.Size = UDim2.new(0, 15, 0, 16)
Toggle.ImageColor3 = Color3.fromRGB(112, 128, 144)
Toggle.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=4731371541"

Main.Name = "Main"
Main.Parent = Top
Main.AnchorPoint = Vector2.new(0.5, 0.5)
Main.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
